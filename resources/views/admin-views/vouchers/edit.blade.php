<x-app-layout>
    ...
    <div class="py-12 bg-gradient-to-b from-black to-gray-800">
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.vouchers.update', $voucher->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="name" type="text" name="name" :value="old('name', $voucher->name)" autofocus
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="4"
                                ...
                                class="mt-1 block w-full p-2 border border-gray-300 rounded-md">{{ old('description', $voucher->description) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="start_date" type="date" name="start_date" :value="old('start_date', $voucher->start_date)"
                                class="mt-1 block w-full p-2 border border-gray-300 rounded-md" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="end_date" type="date" name="end_date" :value="old('end_date', $voucher->end_date)"
                                class="mt-1 block w-full p-2 border border-gray-300 rounded-md" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="discount" type="number" name="discount" :value="old('discount', $voucher->discount)" min="0"
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="price" type="number" name="price" :value="old('price', $voucher->price)" min="0"
